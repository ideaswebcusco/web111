...
<table width="800" border="1" align="center" cellpadding="8" cellspacing="0">
  <tr>
    ...
    <table width="780" border="0" cellpadding="5" cellspacing="5">
      ...
      <tr>
        <td align="center">
        <button type="button" onclick="location.href = 'banner_nuevo.php'"><img src="imagenes/add.png"/><div>Agregar</div></button>
      ...
      <tr>
        ...
        <table width="100%" border="1" align="center">
          <tr>
            ...
            <td width="83%" align="left" bgcolor="#CCCC99">Titulo Banner</td>
...
$sql="SELECT * FROM tbanner ORDER BY orden";
$consulta=mysql_query($sql,$conect);
	...
	while ($columna=mysql_fetch_array($consulta)){
		...
		echo "<td align='center' valign='top'><a href='banner_editar.php?id=$columna[0]'><img src='imagenes/editar.png' title='Editar >> $columna[titulo1]' width='20px' height='19px' border='0'></a></td>";
		echo "<td align='center' valign='top'><a href='banner_eliminar.php?id=$columna[0]'><img src='imagenes/delete.png' title='Eliminar >> $columna[titulo1]' width='20px' height='19px' border='0'></a></td>";		
		echo "</tr>";
		}
?>
</table>
