...
<div id="contenedor">
    ...
    <section>
    	...
    	<div id="capamedio">
            ...
            <div style="font-size:24px; font-weight:bolder; margin:5px 0; padding:5px 20px; color:#F60; background:#F5F0AD; border-radius:15px;">Triple room</div> 
            
            <div style=" padding:10px; margin-bottom:10px; border:1px #999 dashed; background:#EBEBEB; border-radius:15px;">
                <p><b>TRIPLE ROOM</b></p>
                <img src="images/simple.jpg" width="465" height="200">
                <p>Our rooms are equipped with comfortable beds, private bathroom, hot water, cable TV, telephone; They have large windows and pleasant decor which makes them very comfortable.</p>
                
                <p><b>OUR ROOMS INCLUDE</b></p> 
                <ul>
                    <li>Breakfast.</li>
                    <li>Phone.</li>
                    <li>TV Cable.</li>
                    <li>Private bathroom, hot water 24 hours.</li>
                </ul> 
                ...
                <ul>
                    ...
                    <li>Tourist tickets.</li>
                    <li>Transportation services.</li>
                    <li>Special discounts for customers, groups or long stays.</li>
                </ul>              
                
                <div class="verroom"><a href="triple-room.php">Reserve</a></div> 
            </div> 			
