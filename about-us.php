...
<div id="contenedor">
    ...
    <section>
    	...
    	<div id="capamedio">
            ...
            <div style="font-size:24px; font-weight:bolder; margin:5px 0; padding:5px 20px; color:#F60; background:#F5F0AD; border-radius:15px;">About us</div> 
            <div style=" padding:10px; margin-bottom:10px; border:1px #999 dashed; background:#EBEBEB; border-radius:15px;">
                <p><b>Mission</b></p>            
            	<p>Provide personalized service and maintain a philosophy of excellence in customer service; making the customer feel comfortable, quiet and satisfied; thus give each guest a memorable experience and collaborator. Exceeding the expectations of our customers.</p>
                <div align="center"><img src="images/mision.jpg"></div>
				<p><b>View</b></p> 
           		<p>The hostel santa teresa vision is to become the refuge of the traveler who comes to fulfill his dream of visiting the Cusco and the marvelous Machu Picchu, to the suggestions of our customers are our best tool.</p>
        	</div>			
