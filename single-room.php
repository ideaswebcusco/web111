...
<div id="contenedor">
    ...
    <section>
    	...
    	<div id="capamedio">
            ...
            <div style="font-size:24px; font-weight:bolder; margin:5px 0; padding:5px 20px; color:#F60; background:#F5F0AD; border-radius:15px;">Single room</div> 
            ...
            <div style=" padding:10px; margin-bottom:10px; border:1px #999 dashed; background:#EBEBEB; border-radius:15px;">
                ...
                <div class="verroom"><a href="simple-room.php">Reserve</a></div> 
            </div> 			
