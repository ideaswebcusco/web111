...
<div id="contenedor">
    ...
    <section>
    	...
    	<div id="capamedio">
            ...
            <div style="font-size:24px; font-weight:bolder; margin:5px 0; padding:5px 20px; color:#F60; background:#F5F0AD; border-radius:15px;">Santa Teresa, services we provide</div> 
